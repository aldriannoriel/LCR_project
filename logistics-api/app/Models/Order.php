...
{
    protected $fillable = [
        'awb_number', 'hub_id', 'status', 'sender_name', 'recipient_name',
        'recipient_address', 'weight_kg', 'flag_reason', 'scanned_at', 'rider_id',
        'assigned_at', 'dispatched_at', 'delivered_at', 'delivery_status', 'current_hub_id', 'hub_scanned_at',
    ];

    protected function casts(): array
    {
        return ['weight_kg' => 'decimal:2', 'scanned_at' => 'datetime', 'hub_scanned_at' => 'datetime', 'assigned_at' => 'datetime', 'dispatched_at' => 'datetime', 'delivered_at' => 'datetime'];
    }
